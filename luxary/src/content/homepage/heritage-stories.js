...
export const heritageStoriesContent = {
  heading: "Heritage & Legacy",
  description:
    "Discover the origins, milestones, and cultural significance behind the world's most iconic luxury brands.",
  sectionCTA: cta.exploreStoriesSection,
  featuredStory: {
    slug: "history-of-rolex",
    title: "The History of Rolex: A Century of Precision",
    summary:
  ...
  supportingStories: [
    {
      slug: "origins-of-louis-vuitton",
      title: "Origins of Louis Vuitton",
      summary:
    ...
    {
      slug: "dior-new-look-revolution",
      title: "The New Look Revolution",
      summary:
    ...
    {
      slug: "rolls-royce-spirit-of-ecstasy",
