...
export const editorialContent = {
  ...
  description:
    "Curated insights, design analysis, and timeless perspectives on the world of luxury.",
  sectionCTA: cta.readEditorials,
  featuredEditorial: {
    slug: "future-of-luxury",
    title: "The Future of Luxury: Craft in a Digital Age",
    summary:
  ...
  supportingEditorials: [
    {
      slug: "evolution-of-watchmaking",
      title: "Evolution of Watchmaking",
      summary:
    ...
    {
      slug: "luxury-design-principles",
      title: "Luxury Design Principles",
      summary:
    ...
    {
      slug: "cultural-impact-of-luxury",
      title: "The Cultural Impact of Luxury",
      summary:
