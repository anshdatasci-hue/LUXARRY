          ...
          <MotionSectionReveal>
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-relaxed text-muted sm:text-xl">
                Explore the histories, archives, founders, cultural moments,
                and workshop disciplines that give luxury its deeper meaning.
                These are narratives of heritage, craft, and continuity.
              </p>
